...
EXPORT_MODEL_NAME="${EXPORT_MODEL_NAME:-Qwen2.5-3B-Instruct-search-episode-skill-sft}"
TRAINER_LOGGER="${TRAINER_LOGGER:-['console','wandb']}"

DATA_DIR="${DATA_DIR:-$PROJECT_ROOT/outputs/search_episode_skill_pipeline_v2_qwen25_3b}"
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen25-3b-search-episode-skill-sft-v2-ep${TOTAL_EPOCHS}}"
OUTPUT_DIR="${OUTPUT_DIR:-$MODELS_ROOT/outputs/sft/search_episode_skill_analyzer_v2_qwen25_3b_ep${TOTAL_EPOCHS}_${RUN_ID}}"
LOG_DIR="${LOG_DIR:-$MODELS_ROOT/logs/sft}"
LOG_FILE="${LOG_FILE:-$LOG_DIR/search_episode_skill_analyzer_v2_qwen25_3b_ep${TOTAL_EPOCHS}_${RUN_ID}.log}"
