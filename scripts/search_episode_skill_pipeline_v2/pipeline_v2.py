...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="outputs/search_episode_skill_pipeline_v2")
...
def write_metrics(
    *,
    ...
    payload = {
        "version": "search_v2_no_skill_validation",
...
def main() -> None:
    ...
    logging.info("Search QA episode-skill pipeline v2 complete. Outputs are in %s.", output_dir)
