...
EXPORT_MODEL_NAME="${EXPORT_MODEL_NAME:-Qwen2.5-3B-Instruct-webshop-episode-skill-sft-${SFT_SELF_SUFFIX}}"
TRAINER_LOGGER="${TRAINER_LOGGER:-['console','wandb']}"

DATA_DIR="${DATA_DIR:-$PROJECT_ROOT/outputs/webshop_episode_skill_pipeline_v2_qwen25_3b_${SFT_SELF_DIR_SUFFIX}}"
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen25-3b-webshop-episode-skill-sft-v2-ep${TOTAL_EPOCHS}}"
OUTPUT_DIR="${OUTPUT_DIR:-$MODELS_ROOT/outputs/sft/webshop_episode_skill_analyzer_v2_qwen25_3b_ep${TOTAL_EPOCHS}_${RUN_ID}}"
LOG_DIR="${LOG_DIR:-$MODELS_ROOT/logs/sft}"
LOG_FILE="${LOG_FILE:-$LOG_DIR/webshop_episode_skill_analyzer_v2_qwen25_3b_ep${TOTAL_EPOCHS}_${RUN_ID}.log}"
...
if [[ "$EXPORT_MODEL_AFTER_TRAIN" == "true" ]]; then
    ...
    echo "Exporting latest WebShop SFT checkpoint"
