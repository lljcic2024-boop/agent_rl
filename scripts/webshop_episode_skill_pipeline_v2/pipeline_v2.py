...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="outputs/webshop_episode_skill_pipeline_v2")
...
def main() -> None:
    ...
    logging.info("WebShop episode-skill pipeline v2 complete. Outputs are in %s.", output_dir)
