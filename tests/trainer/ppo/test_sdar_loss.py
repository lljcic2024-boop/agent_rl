...
from verl.trainer.ppo.core_algos import compute_sdar_loss


def test_sdar_loss_uses_gated_teacher_gap_on_selected_steps():
    ...
    loss, active_ratio, gate_mean, gate_active_ratio, gap_mean = compute_sdar_loss(
        log_prob=log_prob,
        teacher_log_prob=teacher_log_prob,
        response_mask=response_mask,
        sdar_step_mask=step_mask,
        gate_beta=1.0,
