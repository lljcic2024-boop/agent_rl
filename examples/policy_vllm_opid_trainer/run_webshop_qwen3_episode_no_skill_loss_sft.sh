...
# Initialize both policy and policy-vLLM analyzer from the Qwen3 WebShop SFT model.
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-opid-grpo_qwen3_1.7b_webshop_episode_no_skill_loss_sft_policy-vllm}"
