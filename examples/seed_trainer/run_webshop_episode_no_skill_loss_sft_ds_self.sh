...
export HF_MODEL_PATH="${HF_MODEL_PATH:-$MODELS_ROOT/Qwen2.5-3B-Instruct-webshop-episode-skill-sft-ds-self}"
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-seed_qwen2.5_3b_webshop_sft_ds_self_mean-norm}"
