...
MODELS_ROOT=${MODELS_ROOT:?Please set MODELS_ROOT in $ENV_FILE, or export it explicitly.}
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-seed_qwen2.5_3b_webshop_both_no_skill_loss_base}"
