...
# SEED advantage and SDAR teacher/OPD schedule.
...
SEED_SDAR_LOSS_COEF=${SEED_SDAR_LOSS_COEF:-0.01}
SEED_SDAR_GATE_BETA=${SEED_SDAR_GATE_BETA:-5.0}
SEED_SKILL_GEN_LOSS_ENABLE=${SEED_SKILL_GEN_LOSS_ENABLE:-False}
SEED_SKILL_GEN_LOSS_COEF=${SEED_SKILL_GEN_LOSS_COEF:-0.0}
...
# Visual Sokoban episode-skill analysis with the on-policy vLLM policy.
...
SEED_ANALYSIS_PROMPT_VERSION=${SEED_ANALYSIS_PROMPT_VERSION:-sokoban_visual}
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.sdar_loss_coef=$SEED_SDAR_LOSS_COEF \
    actor_rollout_ref.actor.sdar_gate_beta=$SEED_SDAR_GATE_BETA \
